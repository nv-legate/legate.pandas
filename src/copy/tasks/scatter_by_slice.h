...
class ScatterBySliceTask : public PandasTask<ScatterBySliceTask> {
 public:
  struct ScatterBySliceTaskArgs {
    ...
    Legion::Rect<1> range;
    std::vector<ScatterBySliceArg> requests;
    friend void deserialize(Deserializer &ctx, ScatterBySliceTaskArgs &args);
  };

 public:
  static const int TASK_ID = OpCode::SCATTER_BY_SLICE;

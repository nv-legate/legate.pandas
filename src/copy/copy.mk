...
GEN_GPU_SRC += copy/materialize.cu            \
							 copy/tasks/compact.cu          \
							 copy/tasks/concatenate.cu      \
							 copy/tasks/copy_if_else.cu     \
							 copy/tasks/dropna.cu           \
							 copy/tasks/fill.cu             \
							 copy/tasks/materialize.cu      \
							 copy/tasks/read_at.cu          \
							 copy/tasks/scatter_by_mask.cu  \
							 copy/tasks/scatter_by_slice.cu \
							 copy/tasks/slice_by_range.cu   \

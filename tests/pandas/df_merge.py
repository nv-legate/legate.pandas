...
for n in [15, 30, 45]:
    ...
    for key_dtype in key_dtypes:
        ...
        join_legate_hash = ldf1.merge(ldf2, on="key")
    ...
    for key_dtype in key_dtypes:
        ...
        join_legate_hash = ldf1.merge(ldf2, on="key", how="left")
        ...
        join_legate_hash = ldf1.merge(ldf2, on="key", how="outer")

        join_legate_hash["key"] = join_legate_hash["key"].astype(
            join_pandas["key"].dtype
        )
